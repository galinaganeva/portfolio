...
`,l=[{id:1,number:"01",name:"Grandz Bet",tools:["Website","Figma","2023"]},{id:2,number:"02",name:"Space Fortuna",tools:["Website","Figma","2023"]},{id:3,number:"03",name:"Grandz Race",tools:["Website","Figma","2023"]},{id:4,number:"04",name:"Tortuga",tools:["Landing Page","Webflow","2023"]},{id:5,number:"05",name:"Casino En Ligne Nouveau",tools:["Website","Figma","2023"]}],d=()=>`
  ...
  `;document.addEventListener("DOMContentLoaded",()=>{var i;const o=document.querySelector("#main");o&&(o.innerHTML+=a,o.innerHTML+=c,o.innerHTML+=d());const n=document.querySelector("spline-viewer");if(n){const e=(i=n.shadowRoot)==null?void 0:i.querySelector("#logo");e&&e.remove()}document.querySelectorAll(".project").forEach((e,t)=>{e.addEventListener("click",()=>{window.location.href=`/portfolio-new/project${t+1}.html`})})});
